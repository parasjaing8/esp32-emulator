...
const S = StyleSheet.create({
  ...
  pinWrap:      { flex: 1 },
  pinCard:      { borderRadius: 12, borderWidth: 1, padding: 12, gap: 5, minHeight: 120 },
  pinCardSystem:     { borderColor: colors.warning + '50', backgroundColor: colors.warning + '05' },
  pinCardHighShadow: { shadowColor: colors.pinHigh, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.5, shadowRadius: 10, elevation: 6 },
  pinCardHigh:  {},
  numBadge:     { alignSelf: 'flex-start', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3, marginBottom: 2 },
  ...
  stateRow:     { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 'auto' as unknown as number },
  dot:          { width: 8, height: 8, borderRadius: 4 },
  stateText:    { fontSize: 11, fontFamily: 'Inter_700Bold' },
  adcSection:   { gap: 3, marginTop: 2 },
  adcBarBg:     { height: 6, backgroundColor: colors.border, borderRadius: 3, overflow: 'hidden' },
  adcBarFill:   { height: 6, backgroundColor: colors.pinAdc, borderRadius: 3 },
  adcVal:       { fontSize: 10, fontFamily: 'Inter_400Regular', color: colors.pinAdc, textAlign: 'right' },
